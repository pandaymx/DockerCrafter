  ...
  en: {
    translation: {
      ...
      workspace: {
        ...
        batchStopConfirmTitle: "Confirm Stop Workspace",
        batchStopConfirm:
          "Are you sure you want to stop all {{count}} containers in this workspace?",
        cancel: "Cancel",
        confirmStop: "Stop Workspace",
  ...
  zh: {
    translation: {
      ...
      workspace: {
        ...
        moreActions: "更多操作",
        batchStopConfirmTitle: "确认停止工作区",
        batchStopConfirm: "确定要停止该工作区内的所有 {{count}} 个容器吗？",
        cancel: "取消",
        confirmStop: "停止工作区",
        expand: "展开工作区",
        collapse: "折叠工作区",

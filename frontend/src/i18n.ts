...
const resources = {
  en: {
    translation: {
      ...
      noMatchSub: "Please try clearing the search keywords or resetting filter options",
      toast: {
        ...
        backendUpgradeTip: "Tip: To enable control and instruction automation functions on the frontend, the backend API needs to be upgraded as well. Please connect to the control backend."
      },
      workspace: {
        services: "SERVICES",
        running: "RUNNING",
  ...
  zh: {
    translation: {
      ...
      toast: {
        ...
        backendUpgradeTip: "提示：在前端启用控制与指令自动化相关功能，需要同时将后端 API 升级。请连接控制后端。"
      },
      workspace: {
        services: "服务",
        running: "运行中",
